      ...
      <div className="max-w-4xl mx-auto p-8">
        ...
        <section className="bg-gray-900 border-4 border-purple-400 p-6 mb-8">
          ...
          <p className="text-gray-300 mb-4">
            Maximum Extractable Value (MEV) protection layer for preventing front-running and sandwich attacks.
          </p>
        ...
        <section className="bg-gray-900 border-4 border-gray-700 p-6 mb-8">
          ...
          <ol className="list-decimal list-inside space-y-3 text-gray-300">
            <li>Protect transactions from MEV</li>
            <li>Bundle transactions safely</li>
            <li>Bid for inclusion</li>
          </ol>
        </section>
        ...
        <section className="bg-gray-900 border-4 border-gray-700 p-6 mb-8">
          ...
          <ul className="space-y-2 text-gray-300">
            <li>✓ MEV protection contracts</li>
            <li>✓ Transaction bundling</li>
            <li>✓ Private mempool access</li>
            <li>✓ Relay integration</li>
            <li>✓ Transparent protection costs</li>
          </ul>
        </section>
        ...
        <section className="bg-gray-900 border-4 border-green-400 p-6 mb-8">
          ...
          <ol className="list-decimal list-inside space-y-2 text-gray-300">
            ...
            <li>Bundle your transactions</li>
            <li>Select protection level</li>
            <li>Submit through relay</li>
          </ol>
        </section>
